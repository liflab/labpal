...
public class ClaimCallback extends TemplatePageCallback
{
	...
	public String fill(String page, Map<String,String> params, boolean is_offline)
	{
		...
		out = out.replaceAll("\\{%CLAIM_DESCRIPTION%\\}", Matcher.quoteReplacement("<div class=\"description\">" + description + "</div>"));
		...
		out = out.replaceAll("\\{%CLAIM_EXPLANATIONS%\\}", Matcher.quoteReplacement(clm_explanations.toString()));
		return out;
	}
	 ...
	 * @param result The claim's result
