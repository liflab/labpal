...
public class PlotsPageCallback extends TemplatePageCallback
{
	...
	public String getPlots()
	{
		...
		for (int id : ids)
		{
			...
			out.append("<div><ul><li><a class=\"btn-24 btn-gp\" href=\"plot?id=").append(id).append("&amp;format=gp&amp;dl=1\" title=\"Download GnuPlot source file\">GP</a></li>");
			out.append("<li><a class=\"btn-24 btn-pdf\" href=\"plot?id=").append(id).append("&amp;format=pdf&amp;dl=1\" title=\"Download PDF\">PDF</a></li></ul></div>");
			out.append("</div>\n");			
		}
