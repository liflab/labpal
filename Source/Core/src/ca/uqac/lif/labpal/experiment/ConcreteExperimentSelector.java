 ...
 */
public abstract class ConcreteExperimentSelector
{
	/**
	 ...
	 */
	public ConcreteExperimentSelector(/*@ non_null @*/ Laboratory lab)
	{
		super();
		m_laboratory = lab;
	}
	 ...
	 */
	/*@ non_null @*/ public abstract Collection<Experiment> select();
