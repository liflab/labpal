...
public class PlotsPageCallback extends TemplatePageCallback
{
  ...
  public String fill(String page, Map<String, String> params, boolean is_offline)
  {
    ...
    if (GnuPlot.isGnuplotPresent())
    {
      ...
      {
        out = out.replaceAll("\\{%ALL_PLOTS%\\}",
            "<a class=\"btn-24 btn-all-plots\" title=\"Download all plots as a single PDF file\" href=\"/all-plots\">Download all plots</a>");
      }
      out = out.replaceAll("\\{%ALL_PLOTS_LATEX%\\}",
          "<a class=\"btn-24 btn-all-plots-latex\" title=\"Download LaTeX macros for using the plots\" href=\"/all-plots-latex\">Download LaTeX macros</a>");
    }
    else
    {
      out = out.replaceAll("\\{%PLOTS%\\}",
          "<p>Gnuplot was not detected on this system. The plot functionality is disabled.</p>");
    }
  ...
  public String getPlots()
  {
    ...
    for (int id : ids)
    {
      ...
      out.append("<a href=\"plot/").append(id)
          .append("\" target=\"_blank\" title=\"Click on plot to view in new window\">");
      ...
      if (plot instanceof GnuPlot)
      {
        ...
        out.append("<li><a class=\"btn-24 btn-gp\" href=\"plot/").append(id)
            .append("?format=dumb\" title=\"View as ASCII art\" target=\"_blank\">ASCII</a></li>");
      }
      out.append("<li><a class=\"btn-24 btn-pdf\" href=\"plot/").append(id)
          .append("?format=pdf&amp;dl=1\" title=\"Download as PDF\">PDF</a></li>");
      if (t != null)
      {
        out.append("<li><a class=\"btn-24 btn-table\" href=\"table/").append(t.getId())
            .append("\" title=\"Show the data for this plot\">Table</a></li>");
      }
      out.append("</ul></div>\n");
      out.append("</div>\n");
    }
