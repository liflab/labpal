 ...
 *
 */
public class AllPlotsCallback extends RestCallback
{
	protected Laboratory m_lab;

	public AllPlotsCallback(Laboratory lab)
	{
		super(Method.GET, "/plots/pdf");
		m_lab = lab;
	}
	...
	byte[] export(boolean with_captions) throws IOException
	{
		...
		byte[] file_contents = FileHelper.mergePdf(File.createTempFile(getPlotsFilename(m_lab), ".pdf").getPath(),
				tab);
