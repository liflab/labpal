 ...
 * plot of the lab. This file is to be used in conjunction with the
 * {@link AllPlotsCallback}, which produces a single, multi-page PDF file.
 * 
 * @author Sylvain Hallé
 *
 */
public class AllPlotsLatexCallback extends WebCallback
{
	...
	public CallbackResponse process(HttpExchange t)
	{
		...
		out.append("%").append(FileHelper.CRLF).append("% To insert one of the figures into your text, do:").append(FileHelper.CRLF);
		out.append("% \\begin{figure}").append(FileHelper.CRLF).append("% \\usebox{\\boxname}").append(FileHelper.CRLF).append("% \\end{figure}").append(FileHelper.CRLF);
		...
		for (int id : m_lab.getPlotIds())
		{
			...
			out.append("% ----------------------").append(FileHelper.CRLF).append("% Plot: ").append(box_name).append(FileHelper.CRLF);
			out.append("% ----------------------").append(FileHelper.CRLF);
