...
public class LabpalCodeOcean extends LabpalPlatform implements IPlatform
{
  ...
  void exportTables() throws Exception
  {
    ...
    FileManager.writeFile(Config.getProp("pathOutput"), "tables", ".csv",
        allTablesContent.toString());
    FileManager.writeFile(Config.getProp("pathOutput"), "tables", ".html",
  ...
  void exportPlots() throws Exception
  {
    ...
    for (int id : lab.getPlotIds())
    {
      ...
      FileManager.writeFile(Config.getProp("pathOutput"), Config.getProp("imageName") + id, ".png",
          byte_array);
    ...
    for (int id : lab.getPlotIds())
    {
      ...
      FileManager.writeFile(Config.getProp("pathOutput"), Config.getProp("pdfName") + id, ".pdf",
          bytes);
    }
    if (!lstPath.isEmpty())
    {
